...
st.markdown(f"""Il risultato del test Paired t-test \u00e8 {round(sci.stats.ttest_rel(bm25[:,2], p5[:,2])[1],2)}, che a un livello di significativit\u00e0 $alpha$ = 0.05, viene accettata ipotesi nulla ovvero le medie non shanno differenza""")
st.markdown(f"""Il risultato del test Paired t-test \u00e8 {round(sci.stats.ttest_rel(bm25[:,2], map[:,2])[1],2)}, che a un livello di significativit\u00e0 $alpha$ = 0.05, viene accettata ipotesi nulla ovvero le medie non shanno differenza""")

st.markdown("#### Wilcoxon")
st.markdown(f"""Il risultato del test Wilcoxon \u00e8 {round(sci.stats.wilcoxon(bm25[:,2], p5[:,2])[1],2)}, che a un livello di significativit\u00e0 $alpha$ = 0.05, viene accettata ipotesi nulla ovvero le medie non shanno differenza""")
st.markdown(f"""Il risultato del test Wilcoxon \u00e8 {round(sci.stats.wilcoxon(bm25[:,2], map[:,2])[1],2)}, che a un livello di significativit\u00e0 $alpha$ = 0.05, viene accettata ipotesi nulla ovvero le medie non shanno differenza""")


st.markdown("## Analisi P@5")
st.markdown(f"""Il risultato del test Paired t-test \u00e8 {round(sci.stats.ttest_rel(bm25[:,1], p5[:,1])[1],2)}, che a un livello di significativit\u00e0 $alpha$ = 0.05, viene accettata ipotesi nulla ovvero le medie non shanno differenza""")
st.markdown(f"""Il risultato del test Paired t-test \u00e8 {round(sci.stats.ttest_rel(bm25[:,1], map[:,1])[1],2)}, che a un livello di significativit\u00e0 $alpha$ = 0.05, viene accettata ipotesi nulla ovvero le medie non shanno differenza""")

st.markdown("#### Wilcoxon")
st.markdown(f"""Il risultato del test Wilcoxon \u00e8 {round(sci.stats.wilcoxon(bm25[:,1], p5[:,1])[1],2)}, che a un livello di significativit\u00e0 $alpha$ = 0.05, viene accettata ipotesi nulla ovvero le medie non shanno differenza""")
st.markdown(f"""Il risultato del test Wilcoxon \u00e8 {round(sci.stats.wilcoxon(bm25[:,1], map[:,1])[1],2)}, che a un livello di significativit\u00e0 $alpha$ = 0.05, viene accettata ipotesi nulla ovvero le medie non shanno differenza""")
