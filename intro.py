...
Per farlo si usano delle _funzioni di reperimento_ che calcolano un punteggio dai descrittori dei documenti in relazione a quelli della query. Il risultato viene poi usato per ordinare i risultati mettendo in alto i documenti con punteggio maggiore. Maggiore il punteggio maggiore la vicinanza con la query.
Il punteggio nulla ha a che fare con la rilevanza, un documento rilevante si pu\u00f2 trovare al decimo posto e uno non rilevante al primo. 
...
Questo progetto mostrer\u00e0 le differenze in terminin di efficacia tra il bm25 senza QE e due implementazioni per l'espansione automatica della query: k-NN e Word2Vec; usando un dataset creato dall'uso combinato di Elasticseach, come motore di ricerca, e trec_eval per fare le valutazioni sulle performance del metodo utilizzato.
...
2. **Analisi di risultati caratteristici**: 
    - vedremo come hanno risposto le query al metodo usato, in confronto al metodo base senza QE.
...
- Precision at 5 (P@5): misura la precisione dei primi cinque documenti restituiti dal motore di ricerca per una determinata query. La precisione, in generale, \u00e8 definita come la frazione di documenti rilevanti tra quelli recuperati; P@5 indica quindi la percentuale di documenti rilevanti tra i primi cinque risultati restituiti.
